...
class TestExtractTypeHints:
    def test_function_with_annotations(self):
        ...
        assert "add" in hints
        ft = hints["add"]
        from taiyaki_aot_compiler.type_checker.types import NumberType
    ...
    def test_partial_annotations_included(self):
        ...
        hints = extract_type_hints(ts)
        assert "bar" in hints
        from taiyaki_aot_compiler.type_checker.types import NumberType, TypeVar
    ...
    def test_string_return_type(self):
        ...
        from taiyaki_aot_compiler.type_checker.types import StringType
...
"""
    ...
    def test_array_param_type(self):
        ...
        hints = extract_type_hints(ts)
        assert "sum" in hints
        from taiyaki_aot_compiler.type_checker.types import ArrayType, NumberType
    ...
    def test_void_return(self):
        ...
        hints = extract_type_hints(ts)
        assert "log" in hints
        from taiyaki_aot_compiler.type_checker.types import VoidType, StringType
    ...
    def test_boolean_type(self):
        ...
        from taiyaki_aot_compiler.type_checker.types import NumberType, BooleanType
