"""CLI entry point for the Taiyaki AOT Compiler compiler."""
...
def _print_banner():
    ...
    if con:
        ...
        print("Taiyaki AOT Compiler — JavaScript/TypeScript AOT Compiler")
        print()
...
def _cmd_repl(compiler: Compiler, ts_mode: bool = False):
    ...
    import readline
    history_file = os.path.expanduser("~/.taiyaki_aot_repl_history")
    try:
