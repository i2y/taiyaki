...
class BackendBase(ABC):
    ...
    def _module_uses_arrays(self, hir_module: HIRModule) -> bool:
        ...
        from tsuchi.hir.nodes import HIRAllocArray, HIRArrayGet, HIRArraySet, HIRArrayPush, HIRArrayLen, HIRCall
        for func in hir_module.functions:
            for p in func.params:
    ...
    def _generate_ffi_declarations(self) -> list[str]:
        ...
        from tsuchi.type_checker.types import FFIStructType, OpaquePointerType
